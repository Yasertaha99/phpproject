...
<!-- Navbar start -->
<div class="container nav-bar" style="background-color: gray; height: 60px; border-radius: 20px; ">
  <nav class="navbar navbar-expand-lg navbar-dark py-1 fs-5 d-flex justify-content-sm-evenly">
    <a class="navbar-brand px-lg-4 me-5">
      <h1 class="m-0 display-4 fs-1 text-white">PHP-Project</h1>
    </a>
      ...
      <ul class="navbar-nav mx-4 d-flex align-items-center">
        <li class="nav-item">
          <a class="nav-link small d-flex align-items-center" aria-expanded="false">
            <img class="nav-img rounded-circle me-3" src="<?= $_SESSION['user']['image'] ?>" width="50px" />
